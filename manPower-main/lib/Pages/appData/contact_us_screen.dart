  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
            "${AppLocalizations.of(context)?.translate('callUs')}",style: TextStyle(color: Color(0xFF0671bf))),
        centerTitle: true,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios,color: Color(0xFF0671bf),),
      ...
      body: isLoading? Center(child: CircularProgressIndicator(),):SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text("لتسجيل مركز تعليمى او مدرس مستقل",style: TextStyle(color: Colors.green),),

            Text("اتصل بنا على",style: TextStyle(color: Colors.green),),
            InkWell(
              onTap: () => _makePhoneCall('tel: $phoneTxt'),
              child: Text("$phoneTxt",style: TextStyle(color: Color(0xFF0671bf)),),
            ),
            Padding(padding: EdgeInsets.only(top: 10)),
            Text("او راسلنا على",style: TextStyle(color: Colors.green),),
            Text("$emailTxt",style: TextStyle(color: Colors.green),),
            Padding(
